...
function DesktopView({ suggestions }: DesktopViewProps) {
...
for(var i=0; i<suggestions.length; i++){
  ...
  return (
    ...
    <Box sx={{ flexGrow: 1,backgroundColor:"#F2F4FF" ,pt:5}}>
        
        
      <Grid container sx={{justifyContent:"space-evenly"}} spacing={2}>
       
        <Grid xs={12} sm={12} md={12 } xl={3}>
          {/* <Item>xs=4</Item> */}
      ...
      <Grid container spacing={2}>
        ...
        <Card sx={{ minWidth: 275 , height:"270px",marginBottom:3,background: 'radial-gradient(128.88% 128.88% at 103.9% -10.39%, #E84D70 0%, #A337F6 53.09%, #28A7ED 100%)' }}>
      <CardContent>
      <br />
      <br />
      <br />
    ...
    <Card sx={{ minWidth: 275,backgroundColor:"#F7F8FD",border: "none",minHeight: "100%",mt:5, alignItems: "center"}}>
    
    {filtersuggestions.length!=0?
      <FeedbackList suggestions={filtersuggestions} selectedChip={selectedChip} />
    :
    <Card variant="outlined" sx={{ width: "90%",height:" 100%", boxShadow: '0',border:"none" ,display: "flex",justifyContent: "top", flexDirection: "column",}}>
